...
class TransferFeatureUnavailableScreen extends StatelessWidget {
  const TransferFeatureUnavailableScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(0xFF1D1B20), // same as AccountScreen
      appBar: const PrimaryAppBar(title: 'Transfer'),
      body: Center(
        child: Container(
